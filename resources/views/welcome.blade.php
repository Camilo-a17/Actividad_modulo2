...
<head>
    <meta charset="utf-8">
    <title>PIÑUOS - Diplomado M3</title>
...
<body class="bg-white">
    ...
    <div class="container-fluid p-0 nav-bar">
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            <a href="" class="navbar-brand">
                <h1 class="m-0 display-4 font-weight-bold text-uppercase text-white">Piñuos</h1>
            </a>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h3 class="text-primary text-capitalize m-0">Gimnasio y Centro Fitness</h3>
                        <h2 class="display-2 m-0 mt-2 mt-md-4 text-white font-weight-bold text-capitalize">El mejor gimnasio de Sahagún</h2>
                        <a href="" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Únete a nosotras ahora</a>
                    </div>
                </div>
        ...
        <div class="row px-3">
            <div class="col-md-6 p-0">
                <div class="gym-class-box d-flex flex-column align-items-end justify-content-center bg-primary text-right text-white py-5 px-5">
                    ...
                    <a href="" class="btn btn-lg btn-outline-light mt-4 px-4">Únete ahora</a>
                </div>
            </div>
            <div class="col-md-6 p-0">
            ...
            <div class="col-lg-6">
                ...
                <div class="row py-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <h4 class="font-weight-bold">Premiado</h4>
                        <p>Ipsum sanctu dolor ipsum dolore sit et kasd duo</p>
                    </div>
                </div>
                <a href="" class="btn btn-lg px-4 btn-outline-primary">Leer más</a>
            </div>
        </div>
    </div>
    <!-- About End -->
        ...
        <div class="row">
            ...
            <div class="col-lg-4 p-0">
                <div class="d-flex align-items-center bg-primary text-white px-5" style="min-height: 300px;">
                    ...
                    <div class="">
                        <h2 class="text-white mb-3">Ejercicio</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu suscipit orci velit id libero
                        </p>
                    </div>
                </div>
    ...
    <div class="container feature pt-5">
        <div class="d-flex flex-column text-center mb-5">
            ...
            <h4 class="display-4 font-weight-bold">Beneficios de unirse a nuestro GIMNASIO</h4>
        </div>
        <div class="row">
            <div class="col-md-6 mb-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-7">
                        <h4 class="font-weight-bold">Vídeos de instrucción</h4>
            ...
            <div class="col-md-6 mb-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-7">
                        <h4 class="font-weight-bold">Calendario de entrenamientos</h4>
                        <p>Sit lorem ipsum et diam elitr est dolor sed duo. Guberg sea et et lorem dolor sed est sit invidunt, dolore tempor diam ipsum takima  erat tempor</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-7">
                        <h4 class="font-weight-bold">Soporte comunitario</h4>
                        <p>Sit lorem ipsum et diam elitr est dolor sed duo. Guberg sea et et lorem dolor sed est sit invidunt, dolore tempor diam ipsum takima  erat tempor</p>
                    </div>
                </div>
            </div>
    ...
    <div class="subscribe container-fluid my-5 py-5 text-center">
        ...
        <form class="form-inline justify-content-center mb-5">
            <div class="input-group">
                <input type="text" class="form-control-lg" placeholder="Tu Email">
    ...
    <div class="container gym-feature py-5">
        ...
        <div class="tab-class">
            <ul class="nav nav-pills justify-content-center mb-4">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="pill" href="#class-powerlifting">Levantamiento de pesas</a>
                </li>
            </ul>
                        ...
                        <table class="table table-bordered table-lg m-0">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td><h5>Cardio</h5>Fidel Pájaro</td>
                                    <td></td>
                                    <td><h5>Crossfit</h5>Camilo Arrieta</td>
                                    <td></td>
                                    <td><h5>Levantamiento de pesas</h5>Johnny Álvarez</td>
                                    <td></td>
                                    <td><h5>Cardio</h5>Moisés Bustamante</td>
                                </tr>
                                <tr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-lg m-0">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    <th class="bg-secondary text-white align-middle">6.00am - 8.00am</th>
                                    <td class="bg-primary text-white"><h5 class="text-white">Cardio</h5>Fidel Pájaro</td>
                                    <td></td>
                                    <td><h5>Crossfit</h5>Camilo Arrieta</td>
                                    <td></td>
                                    <td><h5>Levantamiento de pesas</h5>Johnny Álvarez</td>
                                    <td></td>
                                    <td class="bg-primary text-white"><h5 class="text-white">Cardio</h5>Moisés Bustamante</td>
                                </tr>
                                <tr>
                                    <th class="bg-secondary text-white align-middle">10.00am - 12.00pm</th>
                                    <td></td>
                        ...
                        <table class="table table-bordered table-lg m-0">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td><h5>Cardio</h5>Fidel Pájaro</td>
                                    <td></td>
                                    <td class="bg-primary text-white"><h5 class="text-white">Crossfit</h5>Camilo Arrieta</td>
                                    <td></td>
                                    <td><h5>Levantamiento de pesas</h5>Johnny Álvarez</td>
                                    <td></td>
                                    <td><h5>Cardio</h5>Moisés Bustamante</td>
                        ...
                        <table class="table table-bordered table-lg m-0">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td><h5>Crossfit</h5>Camilo Arrieta</td>
                                    <td></td>
                                    <td class="bg-primary text-white"><h5 class="text-white">Levantamiento de pesas</h5>Johnny Álvarez</td>
                                    <td></td>
                                    <td><h5>Cardio</h5>Moisés Bustamante</td>
                                </tr>
                                <tr>
                        ...
                        <form>
                            <div class="form-row">
                                <div class="col form-group">
                                    <input type="text" class="form-control form-control-lg bg-dark text-white" placeholder="Peso (KG)">
                                </div>
                                <div class="col form-group">
                                    <input type="text" class="form-control form-control-lg bg-dark text-white" placeholder="Altura (CM)">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col form-group">
                                    <input type="text" class="form-control form-control-lg bg-dark text-white" placeholder="Edad">
                                </div>
                                <div class="col form-group">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Johnny Álvarez</h4>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Moisés Bustamante</h4>
                        <p class="card-text">Trainer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Camilo Arrieta</h4>
                        <p class="card-text">Trainer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <div class="card border-0 bg-secondary text-center text-white">
                    ...
                    <div class="card-body bg-secondary">
                        <h4 class="card-title text-primary">Fidel Pájaro</h4>
                        <p class="card-text">Trainer</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row px-3 align-items-center">
                ...
                <div class="col-md-6">
                    <div class="pl-md-3 d-none d-md-block">
                        <h4 class="text-primary">Testimonio</h4>
    ...
    <div class="footer container-fluid mt-5 py-5 px-sm-3 px-md-5 text-white">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="text-primary mb-4">Contactos</h4>
                <p><i class="fa fa-map-marker-alt mr-2"></i>Sahagún Córdoba - Colombia</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+57 301 216 6458</p>
                <p><i class="fa fa-envelope mr-2"></i>piñuos@gymfit.com</p>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
            <h4 class="text-primary mb-4">Entrenadores</h4>
                <div class="d-flex flex-column justify-content-start">
                    <p><i class="fa fa-angle-right mr-2"></i>Johnny Álvarez</p>
                    <p><i class="fa fa-angle-right mr-2"></i>Moisés Bustamante</p>
                    <p><i class="fa fa-angle-right mr-2"></i>Fidel Pájaro</p>
                    <p><i class="fa fa-angle-right mr-2"></i>Camilo Arrieta</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="text-primary mb-4">Horario de atención</h4>
                <h5 class="text-white">Lunes a Sábado</h5>
                <p>8.00 AM - 9.00 PM</p>
        ...
        <div class="container border-top border-dark pt-5">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-white font-weight-bold" href="index.html">Piñuos</a>2023
            </p>
        </div>
    </div>
    <!-- Footer End -->
